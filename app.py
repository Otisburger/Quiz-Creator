...
class Quiz(db.Model):
    ...
    mails = db.relationship(
        ...
        back_populates="quiz",
        cascade="all, delete-orphan",
        overlaps="sender_user,sent_mail"
    )
...
class Question(db.Model):
    ...
    __table_args__ = (
        db.ForeignKeyConstraint(
            ['quiz_name', 'username'],
            ['quizzes.quiz_name', 'quizzes.username'],
...
class Mail(db.Model):
    ...
    sender_user = db.relationship(
        "User",
        foreign_keys=[sender],
        back_populates="sent_mail",
        overlaps="quiz,mails"
    )
    receiver_user = db.relationship("User", foreign_keys=[receiver], back_populates="received_mail")
